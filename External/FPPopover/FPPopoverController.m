				   ...
				   delegate:(id<FPPopoverControllerDelegate>)delegate
{
    ...
    if(self)
    {
        ...
        self.contentSize = CGSizeMake(115, 95); //default size
...
-(CGRect)bestArrowDirectionAndFrameFromView:(UIView*)v
{
    ...
    _contentView.relativeOrigin = [self.parentView convertPoint:self.origin toView:_contentView];
